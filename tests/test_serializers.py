...
from oaipmh import serializers, validators
...
class MakeListIdentifiersTests(SchemaValidatorMixin, unittest.TestCase):
    ...
    def test_correct_usage(self, mock_utc):
        mock_utc.utcnow.return_value = datetime(2017, 6, 22, 19, 1, 43)
        expected = b'<?xml version=\'1.0\' encoding=\'utf-8\'?>\n<OAI-PMH xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.openarchives.org/OAI/2.0/" xsi:schemaLocation="http://www.openarchives.org/OAI/2.0/ http://www.openarchives.org/OAI/2.0/OAI-PMH.xsd"><responseDate>2017-06-22T19:01:43Z</responseDate><request verb="ListIdentifiers">https://oai.scielo.br/</request><ListIdentifiers><header><identifier>oai:arXiv:cs/0112017</identifier><datestamp>2017-06-14</datestamp><setSpec>set1</setSpec><setSpec>set2</setSpec></header></ListIdentifiers></OAI-PMH>'
        self.assertEqual(expected,
...
class MakeListRecordsTests(SchemaValidatorMixin, unittest.TestCase):
    ...
    def test_correct_usage(self, mock_utc):
        ...
        self.assertEqual(expected,
                serializers.serialize_list_records(self.data))
